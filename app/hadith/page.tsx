...
import { hadiths } from "@/data/hadith-data"
      ...
      <main className="flex-1 container py-8 md:py-12">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl font-bold tracking-tight">Authentic Hadiths</h1>
            <p className="text-muted-foreground">
              Explore the sayings and traditions of Prophet Muhammad ﷺ from reliable sources.
            </p>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <Input placeholder="Search hadiths..." className="w-full md:w-[300px]" />
          ...
          <div className="flex items-center justify-center gap-2 py-4">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/hadith?page=2">2</Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href="/hadith?page=3">3</Link>
            </Button>
            <Button variant="outline" size="icon" asChild>
              <Link href="/hadith?page=2">
